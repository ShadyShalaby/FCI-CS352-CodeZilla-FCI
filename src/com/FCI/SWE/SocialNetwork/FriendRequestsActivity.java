	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			/*	   String temp = (String) list.getItemAtPosition(position);
	                 //disp.setText(temp);
				Toast.makeText(Application.getAppContext(),temp,Toast.LENGTH_SHORT).show();
			*/
			UserController controller = Application.getUserController();
				controller.addfriend(	names[position]);
				   ...
				   Button button = (Button) findViewById(R.id.button1);
			         button.setOnClickListener(new View.OnClickListener() {
			             public void onClick(View v) {
			            		//Toast.makeText(Application.getAppContext(),position,Toast.LENGTH_SHORT).show();      
			          	  ...
			          	  //String temp = (String) list.getItemAtPosition(position);
			                 //disp.setText(temp);
						Toast.makeText(Application.getAppContext(),"ffffff",Toast.LENGTH_SHORT).show();
			             }
			         });
